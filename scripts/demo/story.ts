...
export interface DemoItineraryDay {
  /** Offset from the trip's first day. 0 is arrival. */
  dayOffset: number;
  title: string;
  notes?: string;
  items: {
...
const lisbon: DemoTrip = {
  ...
  vibe: [
    {
      title: "Pastéis de Belém, before 9am",
      description:
        "The queue after ten is 40 minutes. Before nine it is nothing. This is the entire tip.",
      url: "https://example.com/lisbon/pasteis",
      imageUrl: PHOTOS.pastelDeNata,
      tags: ["Food", "Lisbon", "Do this first"],
      proposedBy: "priya",
      daysAgo: 21,
      votes: [
        { person: "priya", vote: "love" },
    ...
    {
      title: "Tram 28, but from the far end",
      description:
        "Board at Martim Moniz and you stand for an hour. Board at Campo de Ourique going the other way and you sit down.",
      url: "https://example.com/lisbon/tram-28",
      imageUrl: PHOTOS.lisbonTram,
      tags: ["Lisbon", "Cheap", "Overrated?"],
      proposedBy: "marcus",
      daysAgo: 20,
      votes: [
        { person: "marcus", vote: "love" },
    ...
    {
      title: "Belém at sunset, not at noon",
      description:
        "Same tower, no coach parties, and the light is doing the work for you.",
      imageUrl: PHOTOS.belemTower,
      tags: ["Lisbon", "Photos"],
      proposedBy: "ava",
      daysAgo: 18,
      votes: [
        { person: "ava", vote: "love" },
        { person: "priya", vote: "love" },
        { person: "nina", vote: "love" },
        { person: "dev", vote: "fine" },
      ],
    },
    {
      title: "Costa Vicentina — the empty side",
      description:
        "West coast, an hour from Lagos. Colder water, no crowd, and the drive is the good part.",
      url: "https://example.com/algarve/costa-vicentina",
      imageUrl: PHOTOS.costaVicentina,
      tags: ["Beach", "Surf", "Day trip"],
      proposedBy: "tomas",
      daysAgo: 15,
      votes: [
        { person: "tomas", vote: "love" },
    ...
    {
      title: "Kayak into the Benagil cave at 8am",
      description:
        "Every tour goes at eleven and it is shoulder to shoulder. The eight o'clock boat has six people on it.",
      url: "https://example.com/algarve/benagil-cave",
      imageUrl: PHOTOS.benagil,
      tags: ["Algarve", "Booked", "Early start"],
      proposedBy: "dev",
      daysAgo: 12,
      votes: [
        { person: "dev", vote: "love" },
    ...
    {
      title: "Porto as a day trip instead",
      description:
        "Alfa Pendular, 2h45 each way. Out on the 7am, back on the 9pm, and nobody loses a beach day.",
      url: "https://example.com/portugal/porto-day-trip",
      imageUrl: PHOTOS.porto,
      tags: ["Compromise", "Train", "Optional"],
      proposedBy: "priya",
      daysAgo: 25,
      votes: [
        { person: "priya", vote: "love" },
  ...
  itinerary: [
    {
      dayOffset: 0,
      title: "Land, drop bags, do nothing ambitious",
      notes:
        "Four flights arriving between 11:20 and 16:40. Nobody plans anything before seven.",
      items: [
        {
          time: "11:20",
          title: "LGW → LIS lands",
        ...
        },
        {
          ...
          description:
            "Booked for seven. Priya has checked there is more than one vegetarian counter.",
          type: "food",
    ...
    {
      dayOffset: 1,
      title: "Lisbon on foot",
      items: [
        {
          time: "08:15",
          title: "Pastéis de Belém",
          description: "Before nine or it isn't worth it.",
          type: "food",
          location: "Belém",
          addedBy: "priya",
        },
        {
          time: "10:00",
          title: "Belém Tower and the monastery",
          type: "activity",
          location: "Belém",
          cost: "84.00",
          addedBy: "ava",
        },
        {
          ...
          description:
            "Alfama for whoever wants it, a nap for whoever doesn't.",
          type: "free",
          addedBy: "ava",
        },
        {
          time: "21:00",
          title: "Fado night",
          description: "Six seats — Marcus is out, calls on the Tuesday.",
          type: "activity",
          location: "Alfama",
          cost: "154.00",
          addedBy: "priya",
    ...
    {
      dayOffset: 2,
      title: "Porto, for those who want it",
      notes: "Optional day. The compromise that ended the Porto argument.",
      items: [
        {
          time: "07:00",
          title: "Alfa Pendular to Porto",
          type: "transport",
        ...
        {
          time: "12:00",
          title: "Lunch, then the Douro side",
          type: "food",
      ...
      items: [
        {
          ...
          description:
            "Nine seater. Tomás is driving, which means Tomás is not doing the 2am nights.",
          type: "transport",
          cost: "540.00",
          addedBy: "tomas",
        },
        {
          time: "13:00",
          title: "Ericeira, one night",
          description: "Surfable in the morning for whoever is up.",
          type: "accommodation",
          location: "Ericeira",
          addedBy: "tomas",
        },
    ...
    {
      dayOffset: 5,
      title: "Benagil — check in",
      items: [
        {
          time: "16:00",
          title: "Quinta do Benagil",
          description:
            "Ground-floor room is Ava's. Everyone else fights it out upstairs.",
          type: "accommodation",
    ...
    {
      dayOffset: 6,
      title: "The cave, early",
      items: [
        {
          time: "08:00",
          title: "Benagil cave kayak",
          description: "The eight o'clock boat, not the eleven o'clock one.",
          type: "activity",
        ...
        },
        {
          time: "13:00",
          title: "Nothing scheduled",
          description: "The pool is right there and it cost enough.",
          type: "free",
          addedBy: "ava",
        },
      ],
...
const chamonix: DemoTrip = {
  ...
  vibe: [
    {
      title: "Aiguille du Midi, first cable car",
      description:
        "Go up at eight or queue for ninety minutes. Also, it is genuinely cold up there.",
      imageUrl: PHOTOS.montBlanc,
      tags: ["Chamonix", "Early start", "Not skiing"],
      proposedBy: "ava",
      daysAgo: 5,
      votes: [
        { person: "ava", vote: "love" },
    ...
    {
      title: "Zermatt at night",
      description:
        "Sofia's case for the expensive option, submitted as evidence.",
      imageUrl: PHOTOS.zermatt,
      tags: ["Zermatt", "Photos"],
      proposedBy: "sofia",
      daysAgo: 6,
...
const kyoto: DemoTrip = {
  ...
  referee: [
    {
      ...
      daysAgo: 259,
      content:
        "Final numbers: **€7,460 against a €8,000 budget** — €135 a head under.\n\nFor next time, three things this group did that most don't: one destination rather than three, accommodation booked eleven months out at 2023 prices, and food left deliberately unbudgeted rather than optimistically underbudgeted.\n\nClone this trip and the dates, the machiya and the itinerary come with it. The votes don't, which is the point — next year's group makes next year's decisions.",
    },
  ],

  vibe: [
    {
      title: "Fushimi Inari before six",
      description:
        "The gates are empty until about half past seven. After that it is a queue with a shrine attached.",
      imageUrl: PHOTOS.fushimiInari,
      tags: ["Kyoto", "Early start", "Worth it"],
      proposedBy: "yuki",
      daysAgo: 280,
      votes: [
        { person: "yuki", vote: "love" },
    ...
    {
      title: "Kiyomizu-dera, lit up at night",
      description:
        "Only during the autumn opening. Book the slot, don't chance it.",
      imageUrl: PHOTOS.kiyomizu,
      tags: ["Kyoto", "Autumn only", "Book ahead"],
      proposedBy: "priya",
      daysAgo: 278,
      votes: [
        { person: "priya", vote: "love" },
  ...
  itinerary: [
    {
      dayOffset: 0,
      title: "Arrive, eat, sleep",
      items: [
        {
          time: "14:10",
          title: "KIX → Kyoto, Haruka express",
          type: "transport",
          cost: "72.00",
          addedBy: "yuki",
        },
        {
          time: "19:00",
          title: "Nishiki market, standing up",
          type: "food",
          location: "Nishiki",
          addedBy: "priya",
        },
    ...
    {
      dayOffset: 1,
      title: "Fushimi Inari, then nothing",
      items: [
        {
          time: "05:45",
          title: "Fushimi Inari-taisha",
          description:
            "Before six. This was the right call and everyone said so afterwards.",
          type: "activity",
          location: "Fushimi-ku",
          addedBy: "yuki",
        },
        {
          time: "12:00",
          title: "Deliberately empty afternoon",
          type: "free",
          addedBy: "ava",
        },
      ],
    },
    {
      ...
      items: [
        {
          time: "08:00",
          title: "Bamboo grove and the river",
          type: "activity",
          location: "Arashiyama",
          addedBy: "ben",
        },
    ...
    {
      dayOffset: 6,
      title: "Kiyomizu-dera at night",
      items: [
        {
          time: "18:30",
          title: "Autumn evening opening",
          description:
            "Booked slot. Worth the queue that still happens anyway.",
          type: "activity",

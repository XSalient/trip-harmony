...
| Path                              | What it is                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `public/icons/`                   | Favicons, apple-touch and PWA icons, in three tints — see `index.html`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `src/components/trip/`            | Shared trip UI for the trip page and the proposal screens. The trip page itself: `SectionCard` (a section, its header and its Add button), `useSectionState` (which sections are collapsed, per trip in localStorage), `TripSummary`, `ProposalRow`, `useProposalDialogs`, `EditTripDialog`, `TripActionsMenu`, `WatcherNotice`. The proposal screens: `ScreenHeader`, `FinalisedBy`, `AddedBy`, `VotedCount`, `VoteScore`, `LockToggle`, `AbstainButton`, `PreferencesSummary`, `ProposalSuggestions`. Drag and drop: `DraggableChip`, `DraggableMemberChip`, `AttendeePill` |

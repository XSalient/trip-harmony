...
| Table                | Purpose                                                                                                                                                                                                                                                                                                                                                                            |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `trips`              | `inviteCode` (nanoid) is the public join handle. `phase` tracks planning progress; `status` tracks lifecycle. `votingUnit` is `member` (default) or `group`. `hiddenSections` is a JSON array of the section keys in `shared/sections.ts` that this trip has switched off — null means none, and it records what is _off_ so a section added later appears on every existing trip. |

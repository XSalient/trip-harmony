...
| [0027](0027-an-invite-link-is-a-request.md)                      | An invite link is a request, not an entry                      | Amended by 0028 |
| [0028](0028-the-shared-link-is-off-by-default.md)                | The shared invite link is off by default, and spends itself    | Accepted        |

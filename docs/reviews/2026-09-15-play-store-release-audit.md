...
outright, and five more are the kind of thing that shows up in the first week of
...
## B1. There is no account-deletion web URL — Confirmed
...
6. **B1** — a public `/delete-account` page. Cannot submit the Data safety form
   without the URL.

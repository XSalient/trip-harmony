...
for it. Written 2026-08-11 against the app as it stands today.
...
| Cities, stops, saved places | `destinations`, `vibeItems`                    |
| Hotel / Airbnb booking      | `accommodations` (+ `accommodationAttributes`) |
| Day-by-day plan             | `itineraryDays`, `itineraryItems`              |

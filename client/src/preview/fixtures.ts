...
export const accommodations = [
  {
    ...
    freeParking: false,
    camperParking: false,
    // A comma-separated string, which is what the column holds.
    amenities: "Wi-Fi, Air conditioning, Washing machine, Terrace",
    preferences: null,
  ...
  },
  {
    ...
    freeParking: true,
    camperParking: false,
    amenities: "Pool, Wi-Fi, Parking, Barbecue, Air conditioning",
    preferences: null,

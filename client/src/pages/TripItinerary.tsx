...
export default function TripItinerary() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = trpc.itinerary.getDays.useQuery({ tripId }, { enabled: tripId > 0 });
  ...
  const [itemType, setItemType] = useState<
    "activity" | "food" | "transport" | "accommodation" | "free" | "other"
  >("activity");
                            ...
                            >
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 flex-wrap">
                                  ...
                                  <Badge
                                    className={`text-[10px] rounded-full px-2 py-0 ${TYPE_COLORS[item.type] || TYPE_COLORS.other}`}
                                  >
          ...
          <Card className="border-dashed">
            <CardContent className="p-10 text-center">
              ...
              {isAdmin ? (
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  The organizer will add days to the itinerary.
                </p>
              )}
            </CardContent>
          </Card>
          ...
          <div className="space-y-3 pt-1">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full mt-1 rounded-lg border border-border bg-background text-sm px-3 py-2"
                >
            ...
            <div>
              ...
              <Input
                ...
                placeholder="e.g. Visit Rijksmuseum"
                className="rounded-lg mt-1"
              />
            </div>
            <div>

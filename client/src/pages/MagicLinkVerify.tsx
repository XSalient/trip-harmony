      ...
      <div className="text-center space-y-4 max-w-sm w-full">
        ...
        {isError && (
          <>
            ...
            <h2 className="text-xl font-semibold">This magic link has expired</h2>
            <p className="text-muted-foreground text-sm">
              Magic links expire after 15 minutes for your security, and each one can only be used once.
            </p>
            <div className="space-y-2 pt-2">
              <Button
                className="w-full"
                onClick={() => { setStartWithPassword(false); setAuthOpen(true); }}
              >
                Request a New Link
              </Button>
              <Button
                variant="outline"
                className="w-full"
                onClick={() => { setStartWithPassword(true); setAuthOpen(true); }}
              >

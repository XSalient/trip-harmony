        ...
        {done ? (
          <div className="space-y-4 mt-2 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Your password is set. You can now sign in with your email and password on any device.
            </p>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-2">
            {!hasPassword && (
              <p className="text-sm text-muted-foreground text-center">
                Your account was created with a sign-in link and has no password yet. Set one so you can always
                sign in, even on a new device.
              </p>
            )}
            {hasPassword && (
